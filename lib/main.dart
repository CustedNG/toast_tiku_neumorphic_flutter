...
import 'package:toast_tiku/core/extension/string.dart';
...
Future<void> initApp() async {
  ...
  await doDbUpgrade();
  backendUrl = switch (locator<SettingStore>().backendUrl.fetch()) {
    null || '' => defaultBackendUrl,
    final val when val.isHttpUrl => val,
    _ => defaultBackendUrl,
  };
